...
// The matcher is generated by tablegen: its DEBUG_WITH_TYPE() calls compile
// away to an empty else branch, and getMatchClassName() is only referenced
// from debug output. Both warnings belong to the generator, not to us.
#if defined(__GNUC__)
